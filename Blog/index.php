...
<div class="container">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            ...
            <div class="carousel-caption d-none d-md-block">
              <h3>Slide 1</h3>
              <p>Extremely important, please read!!!</p>
            </div>
          </div>
  ...
  <div class="row">
    <div class="col-lg-4 col-md-6 cardContainer">
      <div class="card">
        <a href="post.php"><img class="card-img-top cardImage" src=" http://res.cloudinary.com/dmliyxggm/image/upload/v1511702046/poster_ysydov.jpg" alt="Card image cap"></a>

        <div class="card-block">
          <a href="post.php"><h4 class="card-title">Trekking</h4></a>
